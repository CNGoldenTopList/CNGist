...
import * as trackerChallengeSelection from "./modules/tracker/routes/tracker-challenge-selection";
...
export const routes = [
  ...
  { method: "POST", url: "/api/tracker/challenge-selection", handler: trackerChallengeSelection.POST },
